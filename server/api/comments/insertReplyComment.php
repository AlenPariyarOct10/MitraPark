...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_SESSION['user']['uid'])) {
        ...
        if ($parentCommentId && $commentAuthor && $commentContent) {
            ...
            $insertReplyCommentQuery = "INSERT INTO reply_comments (parent_comment_id, comment_author, created_timestamp, comment_content) VALUES ('$parentCommentId', '$commentAuthor', '$dateTime', '$commentContent')"; // Corrected the SQL query
