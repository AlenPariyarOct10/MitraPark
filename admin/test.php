...
<head>
	...
	<title>Admin - <?php echo $aboutSite['system_name']; ?></title>
</head>
<body>


	<!-- SIDEBAR -->
		<?php include_once("../admin/parts/sidebar.php"); ?>
	<!-- SIDEBAR -->

	<!-- CONTENT -->
	<section id="content">
		<!-- NAVBAR -->
		<?php include_once("../admin/parts/navbar.php"); ?>
		<!-- NAVBAR -->
		...
		<main>
			...
			<ul class="box-info">
				<li>
					...
					<span class="text">
						<h3><?php echo $getPostsCount['count']; ?></h3>
						<p>Posts</p>
					</span>
				</li>
				<li>
				<i class="bx bxs-group"></i>
					<span class="text">
						<h3><?php echo $getUsersCount['count']; ?></h3>
						<p>Uses</p>
					</span>
				</li>
				<li>
