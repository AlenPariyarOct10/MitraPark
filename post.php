                ...
                <div id="editPostModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div>
                            ...
                            <form class="form-datas post-update-form" id="post-update-form" action="./server/api/updatePost.php" method="post" enctype="multipart/form-data">
                                <input type="file" style="display:none" name="file" id="post-img-uploader" value="<?php echo $getPost['media']; ?>" />
                                ...
                                <div class="form-innner-row">
                                    <div class="inner-form-element">
                                        ...
                                        <div class="row-caption-container">
                                            <textarea name="caption" id="caption" style="color: #222831;" maxlength="999" placeholder="Write something"><?php echo $getPost['content']; ?></textarea>
                                        </div>

                                        <input type="hidden" name="postId" value="<?php echo $postId; ?>">
                                        <label class="length-validate" id="caption-length" for="caption"></div>
                                                ...
                                                <div class="inner-form-element">
                                                    ...
                                                    <div class="post-image-holder">
                                                        <div class="inner-post-image-holder">
                                                            <img id="selected-post-img" class="post-upload-image" src="<?php echo "./" . $getPost['media']; ?>" alt="">
