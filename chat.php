...
<body>
    ...
    <div class="body">
        ...
        <div class="mitra-request-list-item" id="request-1">
                <a class="redirect-to-profile" href="chat.php?uid=3">
                    <img class="mitra-request-profile-list" src="./assets/images/user.png">
                    <span class="uname">
                        Nirpesh Puri
                    </span>
                </a>
            </div><div class="mitra-request-list-item" id="request-1">
                <a class="redirect-to-profile" href="chat.php?uid=4">
                    <img class="mitra-request-profile-list" src="./assets/images/user.png">
                    <span class="uname">
                        Anjali Thapa
                    </span>
